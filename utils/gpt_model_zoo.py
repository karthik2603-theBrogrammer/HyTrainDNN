...
def gpt2_8b(checkpoint=True):
    return GPTLMModel(hidden_size= 3072, num_layers=72, num_attention_heads=16, checkpoint=checkpoint)

def gpt2_9b(context_length, checkpoint=True):
    print("=== Context Length: ", context_length)
    return GPTLMModel(hidden_size= 4480, num_layers=36, num_attention_heads=16, checkpoint=checkpoint, max_seq_len= context_length)

def gpt2_10b(context_length, checkpoint=True):
    return GPTLMModel(hidden_size=4096, num_layers=50, num_attention_heads=16, checkpoint=checkpoint, max_seq_len= context_length)
...
def model_builder(model_size: str) -> callable:
    if model_size == "gpt2_medium":
        ...
        return gpt2_5b
    elif model_size == "gpt2_8b":
        return gpt2_8b
    elif model_size == "gpt2_9b":
        return gpt2_9b
